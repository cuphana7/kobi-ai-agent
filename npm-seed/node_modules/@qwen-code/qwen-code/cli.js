...
import {
  initCpuProfiler
} from "./chunks/chunk-HDOH3QYE.js";
import {
  initStartupProfiler
} from "./chunks/chunk-ITOGNELQ.js";
import {
  normalizeServeFastPathArgv
} from "./chunks/chunk-FXGLL2HL.js";
import "./chunks/chunk-JCH35JB3.js";
import {
  init_esbuild_shims
} from "./chunks/chunk-A4BMJM77.js";
import {
  __name
...
async function buildTopLevelHelpParser() {
  const { default: yargs } = await import("./chunks/yargs-B64EYTCF.js");
  const parser = yargs([]).scriptName("qwen").usage(
    "Usage: qwen [options] [command]\n\nQwen Code - Launch an interactive CLI, use -p/--prompt for non-interactive mode"
  ).version("0.19.8").alias("v", "version").help().alias("h", "help").strict().demandCommand(0, 0);
...
async function printBootstrapVersion() {
  if ("0.19.8") {
    writeStdoutLine("0.19.8");
    return;
  }
  const { getCliVersion } = await import("./chunks/version-NO2XSNNP.js");
...
async function runMcpFastPath(rawArgv) {
  ...
  const [{ default: yargsInstance }, { mcpCommand }] = await Promise.all([
    import("./chunks/yargs-B64EYTCF.js"),
    import("./chunks/mcp-3GCXRTOQ.js")
  ]);
...
async function runCliEntry(rawArgv = process.argv.slice(2)) {
  ...
  if (route === "serve") {
    const { tryRunServeFastPath } = await import("./chunks/fast-path-OV6NIP3K.js");
  ...
  const { main } = await import("./chunks/gemini-NQ3WWBKB.js");
  await main();
}
...
async function handleCriticalError(error) {
  const [{ FatalError }, { AlreadyReportedError }] = await Promise.all([
    import("./chunks/src-BBQSM46M.js"),
    import("./chunks/errors-A54HAADA.js")
  ]);
