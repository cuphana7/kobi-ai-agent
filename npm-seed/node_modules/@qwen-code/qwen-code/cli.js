...
import "./chunks/chunk-GVMXFXQG.js";
import {
  initStartupProfiler
...
async function runCliEntry(rawArgv = process.argv.slice(2)) {
  ...
  if (managedUpdateVersion) {
    ...
    const { installManagedNpmUpdate } = await import("./chunks/managed-npm-update-36U25ZEZ.js");
  ...
  if (route === "serve") {
    const { tryRunServeFastPath } = await import("./chunks/fast-path-4DS2GR5O.js");
  ...
  const { main } = await import("./chunks/llm-YKBQVN7S.js");
...
async function handleCriticalError(error) {
  const [{ FatalError }, { AlreadyReportedError }] = await Promise.all([
    import("./chunks/deferred-core-runtime-EXI7LXLE.js"),
    import("./chunks/errors-OH3DYEDL.js")
  ]);
