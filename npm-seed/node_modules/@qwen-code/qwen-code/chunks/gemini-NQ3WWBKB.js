...
async function main() {
  ...
  if (argv.listExtensions) {
    ...
    const { handleList: handleListExtensions } = await import("./list-KVHF7O4X.js");
  ...
  const { themeManager, AUTO_THEME_NAME } = await import("./theme-manager-WZ4RRMMB.js");
...
${finalArgs[promptIndex + 1]}`;
  ...
  if (argv.resume !== void 0) {
    ...
    if (argv.resume === "") {
      const { showResumeSessionPicker } = await import("./StandaloneSessionPicker-EYRGH6PJ.js");
  ...
  }
  {
    ...
    if (config.isInteractive() && !wasRaw && process.stdin.isTTY) {
      const { startEarlyInputCapture, stopAndGetCapturedInput } = await import("./earlyInputCapture-KNOYZ4MJ.js");
    ...
    if (config.isInteractive()) {
      const { setMaxSizedBoxDebugging } = await import("./MaxSizedBox-5DT2SD7B.js");
    ...
    const { initializeApp } = await import("./initializer-BRFJKRRX.js");
    ...
    if (config.getExperimentalZedIntegration()) {
      const { runAcpAgent } = await import("./acpAgent-GRFTTRHW.js");
    ...
    if (config.isInteractive()) {
      ...
      const { startInteractiveUI } = await import("./startInteractiveUI-JII36UGN.js");
...
${input}`;
    ...
    const { validateNonInteractiveAuth } = await import("./validateNonInterActiveAuth-MPKSRCXD.js");
    ...
    if (inputFormat === "stream-json" /* STREAM_JSON */) {
      ...
      const { runNonInteractiveStreamJson } = await import("./session-5BNM25EZ.js");
    ...
    const { runNonInteractive } = await import("./nonInteractiveCli-PTQI3DV6.js");
