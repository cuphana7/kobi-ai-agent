...
async function loadChannelWorkerRuntime() {
  channelWorkerRuntimePromise ??= Promise.all([
    import("./channel-worker-supervisor-BGUAVITB.js"),
    import("./pidfile-MI5FGYF5.js"),
    import("./runtime-FAWN3GQH.js"),
    import("./cli-entry-path-4VJ3Y6T2.js"),
    import("./channel-worker-group-SCSKCSBJ.js"),
    import("./channel-worker-manager-AHCZCKON.js")
  ]).then(
    ([
      supervisor,
      pidfile,
...
function loadCoreRuntime() {
  coreRuntimePromise ??= import("./core-runtime-6IZNPJUN.js");
...
function loadSettingsRuntimeModules() {
  settingsRuntimePromise ??= Promise.all([
    import("./settings-42FFX5TK.js"),
    import("./environment-7DMLANWW.js"),
    import("./loadedSettingsAdapter-4FQH6Y3D.js"),
    import("./trustedFolders-QRII2BL7.js")
...
function loadChannelWebhookConfigRuntime() {
  channelWebhookConfigRuntimePromise ??= Promise.all([
    import("./runtime-FAWN3GQH.js"),
    import("./config-utils-3YNEDKT4.js")
...
async function loadServeRuntimeModules() {
  const [
    ...
    import("./server-3HUUEDUC.js"),
    import("./bridge-EWCKRGWY.js"),
    import("./spawnChannel-TXNLXP2R.js"),
    import("./process-registry-7LAPI3ZB.js"),
    import("./workspace-service-TP4VRTZF.js"),
    import("./types-HKLPXZB3.js"),
    import("./daemon-status-provider-VSVXVY4O.js"),
    import("./workspace-providers-status-WFBT3LS5.js"),
    import("./workspace-skills-status-CILWVQHU.js"),
    import("./total-session-admission-QUZYGACG.js"),
    import("./workspace-registry-FIUB7MGD.js"),
    import("./workspace-runtime-coordinator-5Z7M36W7.js"),
    import("./prompt-terminal-ledger-5HEXZMWT.js")
  ]);
  return {
...
async function runQwenServeImpl(optsIn, deps, loggerLifecycle) {
  ...
  if (workspaceRegistrationStore === void 0 && process.env["QWEN_SERVE_NO_PERSISTENT_REGISTRATION"] !== "1") {
    const { WorkspaceRegistrationStore } = await import("./workspace-registration-store-M3WKKBJQ.js");
  ...
  const { createDaemonToolGuard } = await import("./daemon-git-worktree-guard-BULXRIDA.js");
  ...
  const buildRuntime = /* @__PURE__ */ __name(async () => {
    const [runtime, core, settingsRuntime, resolvedCliVersion, trustPolicy] = await Promise.all([
      ...
      cliVersionPromise,
      import("./daemon-trust-policy-WVSDS2WT.js")
    ]);
    ...
    const persistDisabledSkillsFn = /* @__PURE__ */ __name((workspace, skillName, enabled, assertGenerationOpen) => withSettingsLock(workspace, async () => {
      ...
      } = await import("./skill-settings-MPHPE43F.js");
      const fresh = loadSettingsForPersistence(workspace);
    ...
    const [{ createSubSessionLauncher }, scheduledTaskRoutes] = await Promise.all([
      import("./create-sub-session-5XHUO2PW.js"),
      import("./scheduled-tasks-LB2PINB3.js")
    ]);
    const { sessionAttachmentsRoots } = await import("./session-attachments-root-BENUIMZM.js");
    ...
    void import("./session-pr-refresh-CSRULMTI.js").then((mod) => {
    ...
    const channelManagementService = /* @__PURE__ */ __name((targetRuntime) => {
      ...
      const pending = (async () => {
        ...
        const [
          ...
          import("./channel-management-service-GRJG5R46.js"),
          import("./channel-settings-store-NXZNLT5L.js")
        ]);
    ...
    const app2 = runtime.createServeApp(opts, () => actualPort, {
      ...
      updateModelContextWindow: /* @__PURE__ */ __name((workspace, key, size, assertGenerationOpen) => withSettingsLock(workspace, async () => {
        assertGenerationOpen();
        const { updateModelContextWindow } = await import("./model-configuration-3JIO6IRV.js");
      ...
      installAuthProvider: /* @__PURE__ */ __name((req, assertGenerationOpen) => withSettingsLock(
        ...
        async () => {
          ...
          const plan = core.buildInstallPlan(
            provider,
            inputs,
            fresh.merged.modelProviders?.[inputs.protocol ?? provider.protocol]
          );
          const adapter = settingsRuntime.loadedSettingsAdapter.createLoadedSettingsAdapter(
            fresh
          );
          const { getAuthTypeFromEnv } = await import("./modelConfigUtils-2BJQI2S4.js");
    ...
    if (workspaceTrustHotReloadAvailable) {
      const [
        ...
        import("./workspace-trust-reconciler-2OPSTQNS.js"),
        import("./daemon-trust-policy-monitor-HXQ2GLTX.js")
      ]);
  ...
  const app = runtimeApp ?? createDelegatingServeApp(bootstrapApp, () => runtimeApp, {
    ...
    isPreAuthRequest: webShellMounted ? (req) => import("./web-shell-static-XSCCMXKQ.js").then(
  ...
  if (opts.channelSelection) {
    try {
      ...
      channelValidationTrustPolicy = await import("./daemon-trust-policy-WVSDS2WT.js");
