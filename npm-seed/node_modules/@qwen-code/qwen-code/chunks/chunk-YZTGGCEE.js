...
async function readWorktreeSessionStrict(filePath) {
  ...
  try {
    ...
    if (!after.isFile() || after.nlink !== 1 || after.size !== bytesRead || after.dev !== opened.dev || after.ino !== opened.ino || !pathStats.isFile() || pathStats.nlink !== 1 || pathStats.dev !== after.dev || pathStats.ino !== after.ino) {
      return {
        state: "invalid",
