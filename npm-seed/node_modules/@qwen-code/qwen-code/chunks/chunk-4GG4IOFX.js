...
__name(isDoubleWidthNonRgiEmojiSequence2, "isDoubleWidthNonRgiEmojiSequence");
function baseVisible2(segment) {
  return segment.replace(leadingNonPrintingRegex2, "");
}
__name(baseVisible2, "baseVisible");
function isZeroWidthCluster2(segment) {
  return zeroWidthClusterRegex2.test(segment);
}
__name(isZeroWidthCluster2, "isZeroWidthCluster");
function isHangulLeadingJamo2(codePoint) {
  return codePoint >= 4352 && codePoint <= 4447 || codePoint >= 43360 && codePoint <= 43388;
}
__name(isHangulLeadingJamo2, "isHangulLeadingJamo");
function isHangulVowelJamo2(codePoint) {
  return codePoint >= 4448 && codePoint <= 4519 || codePoint >= 55216 && codePoint <= 55238;
}
__name(isHangulVowelJamo2, "isHangulVowelJamo");
function isHangulTrailingJamo2(codePoint) {
  return codePoint >= 4520 && codePoint <= 4607 || codePoint >= 55243 && codePoint <= 55291;
}
__name(isHangulTrailingJamo2, "isHangulTrailingJamo");
...
__name(isHangulJamo2, "isHangulJamo");
...
__name(hangulClusterWidth2, "hangulClusterWidth");
...
__name(trailingHalfwidthWidth2, "trailingHalfwidthWidth");
...
__name(isDoubleWidthNonRgiEmojiSequence3, "isDoubleWidthNonRgiEmojiSequence");
function baseVisible3(segment) {
  return segment.replace(leadingNonPrintingRegex3, "");
}
__name(baseVisible3, "baseVisible");
function isZeroWidthCluster3(segment) {
  return zeroWidthClusterRegex3.test(segment);
}
__name(isZeroWidthCluster3, "isZeroWidthCluster");
function isHangulLeadingJamo3(codePoint) {
  return codePoint >= 4352 && codePoint <= 4447 || codePoint >= 43360 && codePoint <= 43388;
}
__name(isHangulLeadingJamo3, "isHangulLeadingJamo");
function isHangulVowelJamo3(codePoint) {
  return codePoint >= 4448 && codePoint <= 4519 || codePoint >= 55216 && codePoint <= 55238;
}
__name(isHangulVowelJamo3, "isHangulVowelJamo");
function isHangulTrailingJamo3(codePoint) {
  return codePoint >= 4520 && codePoint <= 4607 || codePoint >= 55243 && codePoint <= 55291;
}
__name(isHangulTrailingJamo3, "isHangulTrailingJamo");
function isHangulJamo3(codePoint) {
  return isHangulLeadingJamo3(codePoint) || isHangulVowelJamo3(codePoint) || isHangulTrailingJamo3(codePoint);
}
__name(isHangulJamo3, "isHangulJamo");
function hangulClusterWidth3(visibleSegment, eastAsianWidthOptions) {
  const codePoints = [];
  for (const character of visibleSegment) {
    if (zeroWidthClusterRegex3.test(character)) {
      continue;
    }
    codePoints.push(character.codePointAt(0));
  }
  ...
  for (let index = 0; index < codePoints.length; index++) {
    ...
    if (isHangulLeadingJamo3(codePoint) && isHangulVowelJamo3(codePoints[index + 1])) {
      width += 2;
      index += isHangulTrailingJamo3(codePoints[index + 2]) ? 2 : 1;
      continue;
    }
    width += eastAsianWidth(codePoint, eastAsianWidthOptions);
  }
...
__name(hangulClusterWidth3, "hangulClusterWidth");
function trailingHalfwidthWidth3(visibleSegment, eastAsianWidthOptions) {
  let extra = 0;
  let first = true;
  for (const character of visibleSegment) {
    if (first) {
...
__name(trailingHalfwidthWidth3, "trailingHalfwidthWidth");
function stringWidth3(input, options = {}) {
  ...
  for (const { segment } of segmenter4.segment(string)) {
    ...
    const visibleSegment = baseVisible3(segment);
    const hangulWidth = hangulClusterWidth3(visibleSegment, eastAsianWidthOptions);
    if (hangulWidth !== void 0) {
      width += hangulWidth;
      continue;
    }
    const codePoint = visibleSegment.codePointAt(0);
    width += eastAsianWidth(codePoint, eastAsianWidthOptions);
    width += trailingHalfwidthWidth3(visibleSegment, eastAsianWidthOptions);
  }
  return width;
}
...
if (process4.env["DEV"] === "true") {
  ...
  if (isDevtoolsInstalled) {
    await import("./devtools-THK6GHXG.js");
  }
}
...
var zeroWidthClusterRegex4 = new RegExp("^(?:\\p{Default_Ignorable_Code_Point}|\\p{Control}|\\p{Format}|\\p{Mark}|\\p{Surrogate})+$", "v");
var leadingNonPrintingRegex4 = new RegExp("^[\\p{Default_Ignorable_Code_Point}\\p{Control}\\p{Format}\\p{Mark}\\p{Surrogate}]+", "v");
var rgiEmojiRegex4 = new RegExp("^\\p{RGI_Emoji}$", "v");
var unqualifiedKeycapRegex4 = /^[\d#*]\u20E3$/;
var extendedPictographicRegex4 = new RegExp("\\p{Extended_Pictographic}", "gu");
function isDoubleWidthNonRgiEmojiSequence4(segment) {
  if (segment.length > 50) {
    return false;
  }
  if (unqualifiedKeycapRegex4.test(segment)) {
    return true;
  }
  if (segment.includes("\u200D")) {
    const pictographics = segment.match(extendedPictographicRegex4);
    return pictographics !== null && pictographics.length >= 2;
  }
  return false;
}
__name(isDoubleWidthNonRgiEmojiSequence4, "isDoubleWidthNonRgiEmojiSequence");
function baseVisible4(segment) {
  return segment.replace(leadingNonPrintingRegex4, "");
}
__name(baseVisible4, "baseVisible");
function isZeroWidthCluster4(segment) {
  return zeroWidthClusterRegex4.test(segment);
}
__name(isZeroWidthCluster4, "isZeroWidthCluster");
function isHangulLeadingJamo4(codePoint) {
  return codePoint >= 4352 && codePoint <= 4447 || codePoint >= 43360 && codePoint <= 43388;
}
__name(isHangulLeadingJamo4, "isHangulLeadingJamo");
function isHangulVowelJamo4(codePoint) {
  return codePoint >= 4448 && codePoint <= 4519 || codePoint >= 55216 && codePoint <= 55238;
}
__name(isHangulVowelJamo4, "isHangulVowelJamo");
function isHangulTrailingJamo4(codePoint) {
  return codePoint >= 4520 && codePoint <= 4607 || codePoint >= 55243 && codePoint <= 55291;
}
__name(isHangulTrailingJamo4, "isHangulTrailingJamo");
function isHangulJamo4(codePoint) {
  return isHangulLeadingJamo4(codePoint) || isHangulVowelJamo4(codePoint) || isHangulTrailingJamo4(codePoint);
}
__name(isHangulJamo4, "isHangulJamo");
function hangulClusterWidth4(visibleSegment, eastAsianWidthOptions) {
  const codePoints = [];
  for (const character of visibleSegment) {
    if (zeroWidthClusterRegex4.test(character)) {
      continue;
    }
    codePoints.push(character.codePointAt(0));
  }
  ...
  for (let index = 0; index < codePoints.length; index++) {
    ...
    if (isHangulLeadingJamo4(codePoint) && isHangulVowelJamo4(codePoints[index + 1])) {
      width += 2;
      index += isHangulTrailingJamo4(codePoints[index + 2]) ? 2 : 1;
      continue;
    }
    width += eastAsianWidth(codePoint, eastAsianWidthOptions);
  }
...
__name(hangulClusterWidth4, "hangulClusterWidth");
function trailingHalfwidthWidth4(visibleSegment, eastAsianWidthOptions) {
  let extra = 0;
  let first = true;
  for (const character of visibleSegment) {
    if (first) {
...
__name(trailingHalfwidthWidth4, "trailingHalfwidthWidth");
function stringWidth4(input, options = {}) {
  ...
  for (const { segment } of segmenter5.segment(string)) {
    if (isZeroWidthCluster4(segment)) {
      continue;
    }
    if (rgiEmojiRegex4.test(segment) || isDoubleWidthNonRgiEmojiSequence4(segment)) {
      width += 2;
      continue;
    }
    const visibleSegment = baseVisible4(segment);
    const hangulWidth = hangulClusterWidth4(visibleSegment, eastAsianWidthOptions);
    if (hangulWidth !== void 0) {
      width += hangulWidth;
      continue;
    }
    const codePoint = visibleSegment.codePointAt(0);
    width += eastAsianWidth(codePoint, eastAsianWidthOptions);
    width += trailingHalfwidthWidth4(visibleSegment, eastAsianWidthOptions);
  }
  return width;
}
__name(stringWidth4, "stringWidth");
