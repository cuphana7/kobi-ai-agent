...
import {
  ...
  requestUpdateOnExit
} from "./chunk-YIVRT5RA.js";
import {
  loadUndici
} from "./chunk-47QXG7FA.js";
import {
  IdeClient
...
${t(
  ...
  if (options.connectIde && config.getIdeMode()) {
    runDeferredTask("ide_connect", async () => {
      ...
      try {
        const { connectIdeForStartup } = await import("./initializer-ZUO7ORBA.js");
        await withTimeout(
  ...
  if (config.isInteractive()) {
    runDeferredTask("background_housekeeping", async () => {
      const { startBackgroundHousekeeping } = await import("./scheduler-MPMBQKNN.js");
