...
function buildDefaultBasePrompt(interaction, model, outputStyle, todoWriteEnabled = false) {
...
function getCoreSystemPrompt(userMemory, model, appendInstruction, interactionMode = "interactive", outputStyle, todoWriteEnabled = false) {
...
function assembleSystemPrompt(layers) {
  return layers.base + buildSystemPromptSuffix(layers.contextFiles) + buildSystemPromptSuffix(layers.appendPrompt) + (layers.gitStatus ? `
