...
var LEGACY_GOAL_RECORD_KEYS = [
  "evidenceCheckpoint",
  "checkpointStalls",
  "lastCheckpointFailure"
];
var LEGACY_PAYLOAD_KEYS = ["checkpointPending"];
...
function parseGoalStateRecordPayloadV2(value) {
  if (!isRecord(value) || !hasOnlyKeys(value, [
    ...
    "blockedAudit",
    ...LEGACY_PAYLOAD_KEYS
  ]) || value["v"] !== GOAL_STATE_VERSION || !isGoalStateCause(value["cause"]) || !isBlockedAudit(value["blockedAudit"])) {
    return void 0;
  }
