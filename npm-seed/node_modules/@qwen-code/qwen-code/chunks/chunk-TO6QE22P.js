...
function ensureBuiltins() {
  if (!builtinsPromise) {
    builtinsPromise = (async () => {
      const labelled = [
        { name: "telegram", promise: import("./dist-WKPOYU7O.js") },
        { name: "weixin", promise: import("./dist-R7LN5AZE.js") },
        { name: "dingtalk", promise: import("./dist-PNVLTKTL.js") },
        { name: "wecom", promise: import("./dist-XKU3ABM5.js") },
        { name: "feishu", promise: import("./dist-QYCAEZIT.js") },
        { name: "qqbot", promise: import("./dist-VHV4EVHG.js") }
      ];
...
var CHANNEL_APPROVAL_MODES = /* @__PURE__ */ new Set([
  "plan",
  "default",
  "auto-edit",
  "auto",
...
function parseWebhookSource(channelName, path, raw) {
  const record = requireObjectField(channelName, path, raw);
...
function resolveWebhookSecretEnv(channelName, path, secretEnv) {
...
function parseWebhookConfig(channelName, rawConfig) {
...
function parseChannelWebhookConfig(channelName, rawConfig) {
  return parseWebhookConfig(channelName, rawConfig);
}
__name(parseChannelWebhookConfig, "parseChannelWebhookConfig");
function parseChannelWebhookConfigLenient(channelName, rawConfig, onSourceError) {
  const raw = rawConfig["webhooks"];
  if (raw === void 0 || raw === null) {
    return void 0;
  }
