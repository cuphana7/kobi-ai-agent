...
function isInboundEnvelope(value) {
  ...
  return typeof envelope.channelName === "string" && typeof envelope.senderId === "string" && typeof envelope.senderName === "string" && typeof envelope.chatId === "string" && typeof envelope.text === "string" && typeof envelope.isGroup === "boolean" && typeof envelope.isMentioned === "boolean" && typeof envelope.isReplyToBot === "boolean" && (envelope.chatName === void 0 || typeof envelope.chatName === "string") && (envelope.threadId === void 0 || typeof envelope.threadId === "string") && (envelope.messageId === void 0 || typeof envelope.messageId === "string") && (envelope.referencedText === void 0 || typeof envelope.referencedText === "string") && isOptionalStringArray(envelope.mentionedMemberIds) && (envelope.imageBase64 === void 0 || typeof envelope.imageBase64 === "string") && (envelope.imageMimeType === void 0 || typeof envelope.imageMimeType === "string") && (envelope.attachments === void 0 || Array.isArray(envelope.attachments)) && (envelope.metadata === void 0 || typeof envelope.metadata === "string") && (envelope.bypassMessagePrefix === void 0 || envelope.bypassMessagePrefix === true) && (envelope.alreadyPrefixed === void 0 || envelope.alreadyPrefixed === true);
}
...
${details}`
  ...
  async processAggregateLane(ctx) {
    ...
    const comments = newComments.flatMap((comment) => {
      const rawBody = comment.body || "";
      const body = messagePrefix ? stripMessagePrefix(this.botUsername ? stripBotMention(rawBody, this.botUsername) : rawBody, messagePrefix) : rawBody.trim();
      return body === void 0 ? [] : [{ comment, body }];
