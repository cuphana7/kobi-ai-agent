  ...
  async execute(abortSignal) {
    ...
    try {
      ...
      return {
        ...
        error: {
          message,
          type: isNodeError(error) && error.code === "EISDIR" ? "target_is_directory" /* TARGET_IS_DIRECTORY */ : "file_write_failure" /* FILE_WRITE_FAILURE */
        }
      };
    }
    ...
    if (!fileExists2 && !this.config.getShellExecutionSandbox?.()) {
    ...
    try {
      ...
      if (isNodeError(error)) {
        ...
        if (error.code === "ESTALE" && this.config.getShellExecutionSandbox?.()) {
          errorType = "file_changed_since_read" /* FILE_CHANGED_SINCE_READ */;
