...
async function collectSessionMetadata(conversation, config) {
  ...
  let gitRepo;
  if (cwd) {
    const { getGitRepoName } = await import("./deferred-core-runtime-EXI7LXLE.js");
...
<html lang="en" class="dark">
  <head>
    ...
    <link
      ...
      integrity="sha384-Ux4iQYjI9/WNjFY//kYeSYqI27m+iNPiacytu/jC5BNFB6gTuShCkpAHQ2s9NI5a"
  ...
  <body>
    ...
    <script
      ...
      integrity="sha384-EU9Sde3vWsQasTG7cfJPT/Uo2tAGjo39wHvKqRsxUwBxMU1ApImjRh1td9lXJtbG"
      crossorigin="anonymous"
...
`;
var EXPORT_TRANSCRIPT_RENDERER_VERSION = "0.24.0+f2d34af0757a93b3";
