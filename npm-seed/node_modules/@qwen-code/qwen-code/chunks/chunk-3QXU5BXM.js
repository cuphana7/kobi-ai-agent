  ...
  model: {
    ...
    properties: {
      ...
      goalCheckpointTimeoutSeconds: {
        ...
        minimum: 1,
        maximum: 900,
        description: "Deprecated. Goals no longer run evidence-checkpoint model calls, because the verifier reads the transcript directly, so this value is ignored. The key is still accepted so that existing settings files keep loading without an unknown-key warning.",
        showInDialog: false
      },
      maxToolCalls: {
        type: "number",
  ...
  tools: {
    ...
    properties: {
      ...
      shell: {
        ...
        properties: {
          enableInteractiveShell: {
            ...
            requiresRestart: true,
            default: void 0,
            description: "Use node-pty for an interactive shell experience. Explicit one-shot prompts default to child_process when this setting is unset; interactive and input-driven modes default to PTY.",
            showInDialog: true
          },
          pager: {
            type: "string",
      ...
      visible: {
        ...
        requiresRestart: true,
        default: void 0,
        description: "Deferred tool names made visible at startup without requiring the ToolSearch + ToolCall bridge. Listed tools appear alongside core tools in the initial session.",
        showInDialog: false,
        mergeStrategy: "union" /* UNION */
      },
      eager: {
      ...
      liveVoice: {
        ...
        properties: {
          ...
          model: {
            ...
            description: "Realtime model used for Live Voice: a modelId or provider:modelId. When it names a modelProviders entry with realtimeOnly: true, that entry supplies the endpoint (derived from baseUrl) and the key (envKey); otherwise endpoint and apiKey below are used.",
            showInDialog: false
          },
          endpoint: {
            type: "string",
