    ...
    async (providerConfig, inputs) => {
      ...
      try {
        ...
        const plan = buildInstallPlan(
          providerConfig,
          inputs,
          settings.merged.modelProviders?.[inputs.protocol ?? providerConfig.protocol]
        );
...
function useProviderSetupFlow(onSubmit) {
  ...
  const submit = (0, import_react11.useCallback)(() => {
    ...
    const advancedConfig = hasAdvanced ? {
      ...
      multimodal,
      contextWindowSize: ctxSize > 0 && !isNaN(ctxSize) ? ctxSize : void 0
    } : void 0;
  ...
  const getPreviewJson = (0, import_react11.useCallback)(() => {
    if (!provider) return "";
