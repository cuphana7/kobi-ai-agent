...
var pt_default = {
  ...
  "Locked by settings entries you cannot toggle here:": "Bloqueado por entradas de configura\xE7\xE3o (n\xE3o \xE9 poss\xEDvel alternar aqui):",
  "{{count}} locked not shown": "{{count}} habilidades bloqueadas n\xE3o exibidas",
  ...
  "This extension will install the following workflows (JavaScript scripts that can start subagents):": "Esta extens\xE3o instalar\xE1 os seguintes fluxos de trabalho (scripts JavaScript que podem iniciar subagentes):",
  "These workflow scripts changed since the installed version: {{names}}.": "Estes scripts de fluxo de trabalho mudaram desde a vers\xE3o instalada: {{names}}.",
  ...
  "Reopen this menu to reload hook definitions.": "Reabra este menu para recarregar as defini\xE7\xF5es dos hooks.",
  "Hook controls and HTTP security settings require a restart.": "Os controles dos hooks e as configura\xE7\xF5es de seguran\xE7a HTTP exigem uma reinicializa\xE7\xE3o.",
  "Failed to reload hook definitions: {{error}}": "Falha ao recarregar as defini\xE7\xF5es dos hooks: {{error}}",
  ...
  'Input to command is JSON with "prompt" (the current model-bound prompt) and optional "submitted_prompt" (the text projection captured at a supported submission boundary).': 'A entrada para o comando \xE9 JSON com "prompt" (o prompt atual vinculado ao modelo) e o campo opcional "submitted_prompt" (a proje\xE7\xE3o de texto capturada em um ponto de envio compat\xEDvel).',
  ...
  "Could not compress chat history because the compression summary was empty.": "N\xE3o foi poss\xEDvel comprimir o hist\xF3rico do chat porque o resumo da compress\xE3o estava vazio.",
  "Could not compress chat history because the compression summary was truncated.": "N\xE3o foi poss\xEDvel comprimir o hist\xF3rico do chat porque o resumo da compress\xE3o foi truncado.",
  "Could not compress chat history due to an API error.": "N\xE3o foi poss\xEDvel comprimir o hist\xF3rico do chat devido a um erro da API.",
  // ============================================================================
  // Commands - Directory
  // ============================================================================
  ...
  "Large workflow: {{agents}} agents scheduled (warning threshold {{cap}}).": "Workflow grande: {{agents}} agentes agendados (limite de aviso {{cap}}).",
  "Large workflow: ~{{tokens}} output tokens projected (warning threshold {{cap}}).": "Workflow grande: ~{{tokens}} tokens de sa\xEDda previstos (limite de aviso {{cap}}).",
