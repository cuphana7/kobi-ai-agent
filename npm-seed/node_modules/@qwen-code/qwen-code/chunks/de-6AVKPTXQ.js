...
var de_default = {
  ...
  "Locked by settings entries you cannot toggle here:": "Gesperrt durch Einstellungseintr\xE4ge, die hier nicht umgeschaltet werden k\xF6nnen:",
  ...
  "This extension will install the following workflows (JavaScript scripts that can start subagents):": "Diese Erweiterung wird folgende Workflows installieren (JavaScript-Skripte, die Unteragenten starten k\xF6nnen):",
  "These workflow scripts changed since the installed version: {{names}}.": "Diese Workflow-Skripte wurden seit der installierten Version ge\xE4ndert: {{names}}.",
  ...
  "Reopen this menu to reload hook definitions.": "\xD6ffnen Sie dieses Men\xFC erneut, um Hook-Definitionen neu zu laden.",
  "Hook controls and HTTP security settings require a restart.": "Hook-Steuerungsoptionen und HTTP-Sicherheitseinstellungen erfordern einen Neustart.",
  "Failed to reload hook definitions: {{error}}": "Hook-Definitionen konnten nicht neu geladen werden: {{error}}",
  ...
  'Input to command is JSON with "prompt" (the current model-bound prompt) and optional "submitted_prompt" (the text projection captured at a supported submission boundary).': 'Die Eingabe f\xFCr den Befehl ist JSON mit "prompt" (dem aktuellen modellgebundenen Prompt) und optional "submitted_prompt" (der an einer unterst\xFCtzten \xDCbermittlungsgrenze erfassten Textprojektion).',
  ...
  "Could not compress chat history because the compression summary was empty.": "Chatverlauf konnte nicht komprimiert werden, da die Komprimierungszusammenfassung leer war.",
  "Could not compress chat history because the compression summary was truncated.": "Chatverlauf konnte nicht komprimiert werden, da die Komprimierungszusammenfassung abgeschnitten wurde.",
  "Could not compress chat history due to an API error.": "Chatverlauf konnte aufgrund eines API-Fehlers nicht komprimiert werden.",
  // ============================================================================
  // Commands - Directory
  // ============================================================================
  ...
  "Large workflow": "Gro\xDFer Workflow",
  "Large workflow: {{agents}} agents scheduled (warning threshold {{cap}}).": "Gro\xDFer Workflow: {{agents}} Agenten eingeplant (Warnschwelle {{cap}}).",
  "Large workflow: ~{{tokens}} output tokens projected (warning threshold {{cap}}).": "Gro\xDFer Workflow: ~{{tokens}} Ausgabe-Tokens erwartet (Warnschwelle {{cap}}).",
