...
// packages/core/src/tools/computer-use/client.ts
var DEFAULT_COMPUTER_USE_IDLE_TIMEOUT_MS = 5 * 60 * 1e3;
var MAX_COMPUTER_USE_IDLE_TIMEOUT_MS = 2147483647;
var ComputerUseClient = class _ComputerUseClient {
  ...
  async start(onProgress) {
    ...
    this.startPromise = this.doStart(onProgress).then(() => {
      this.scheduleIdleStop();
    }).finally(() => {
...
function normalizeIdleTimeoutMs(value) {
  if (value === void 0) return DEFAULT_COMPUTER_USE_IDLE_TIMEOUT_MS;
...
__name(normalizeIdleTimeoutMs, "normalizeIdleTimeoutMs");
...
async function extractArchive(archivePath, destDir, asset, unzipImpl) {
  if (asset.endsWith(".zip")) {
    ...
    await So({ file: archivePath, cwd: destDir });
  }
}
