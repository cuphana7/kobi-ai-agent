...
import "./chunk-7VEYUF3N.js";
import "./chunk-74TONY4F.js";
import "./chunk-E6TI726I.js";
...
function getNodeMemoryArgs(isDebugMode3) {
  ...
  const totalMemoryMB = os3.totalmem() / (1024 * 1024);
...
async function main() {
  ...
  if (argv.listExtensions) {
    ...
    const { handleList: handleListExtensions } = await import("./list-JOGBAC2R.js");
  ...
  const { themeManager, AUTO_THEME_NAME } = await import("./theme-manager-U6CIK3GM.js");
  ...
  if (!process.env["SANDBOX"]) {
    ...
    const onUpdateRelaunch = /* @__PURE__ */ __name(async (relaunchOnFailure) => {
      ...
      const { updateBeforeRelaunch } = await import("./update-relaunch-XV5O74E3.js");
...
${finalArgs[promptIndex + 1]}`;
  ...
  if (argv.resume !== void 0) {
    ...
    if (argv.resume === "") {
      const { showResumeSessionPicker } = await import("./StandaloneSessionPicker-TXVF65YW.js");
  ...
  }
  {
    ...
    const nonInteractiveHousekeeping = !config.isInteractive() || config.getExperimentalZedIntegration() ? await import("./scheduler-M2YPN7Z7.js") : void 0;
    ...
    if (config.isInteractive() && !wasRaw && process.stdin.isTTY) {
      const { startEarlyInputCapture, stopAndGetCapturedInput } = await import("./earlyInputCapture-BXP7V2P3.js");
    ...
    if (config.isInteractive()) {
      const { setMaxSizedBoxDebugging } = await import("./MaxSizedBox-4C3BKKKY.js");
    ...
    const { initializeApp } = await import("./initializer-4URDQL2G.js");
    ...
    if (config.getExperimentalZedIntegration()) {
      ...
      const { runAcpAgent } = await import("./acpAgent-H5XBKGB4.js");
    ...
    if (config.isInteractive()) {
      ...
      if (selection.renderer === "opentui") {
        try {
          const { startOpenTuiUI } = await import("./start-opentui-ui-IHIIZ2LE.js");
      ...
      const { startInteractiveUI } = await import("./startInteractiveUI-LR7K2ARZ.js");
...
${input}`;
    ...
    const { validateNonInteractiveAuth } = await import("./validateNonInterActiveAuth-ZNUTD3E5.js");
    ...
    if (inputFormat === "stream-json" /* STREAM_JSON */) {
      ...
      const { runNonInteractiveStreamJson } = await import("./session-JVN62R5K.js");
    ...
    const { runNonInteractive } = await import("./nonInteractiveCli-LXGIKQAT.js");
    nonInteractiveHousekeeping?.startNonInteractiveOpenAILogHousekeeping(
      nonInteractiveConfig,
      settings
    );
