...
var WORKSPACE_TIGHTEN_ONLY_SETTINGS = [
  {
    ...
    strictness: /* @__PURE__ */ __name((value) => value === true ? 0 : 1, "strictness")
  },
  {
    section: "agents",
...
function tightenOnlyVerdict(entry, workspace, scopes) {
  ...
  let against = "default";
  let baseline = entry.strictness(void 0);
  for (const [name, settings] of [
    ...
    const rank2 = entry.strictness(value);
    if (against === "default" || rank2 > baseline) {
      against = name;
      baseline = rank2;
    }
  }
