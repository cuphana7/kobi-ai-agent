...
async function collectSessionMetadata(conversation, config) {
  ...
  let gitRepo;
  if (cwd) {
    const { getGitRepoName } = await import("./deferred-core-runtime-Q7WFWYD3.js");
...
<html lang="en" class="dark">
  ...
  <body>
      ...
      (function () {
        ...
        window.addEventListener(
          ...
          function (event) {
            if (
              event.target === window ||
              (event.target && event.target.id === 'transcript-renderer')
            ) {
              showLoadError();
            }
          },
    ...
    <script
      ...
      integrity="sha384-fw8bWYGocO+WEj1+/97lmsi1VF8i5Yl9aur4TezgkOGrCUi+9D8URaZP3/ADoEq6"
      crossorigin="anonymous"
      src="https://unpkg.com/@qwen-code/qwen-code@0.23.2/export-transcript-document.js"
    ></script>
  </body>
</html>
`;
var EXPORT_TRANSCRIPT_RENDERER_VERSION = "0.23.2+d18574e03f32ce10";
...
var DefaultTranscriptReplayMachine2 = class {
  ...
  *projectToolResult(record, emit, meta) {
    ...
    if (isTaskExecutionDisplay2(resultDisplay)) {
      ...
      if (Object.keys(usage).length > 0) {
        this.addUsage(usage);
        yield emit(createTranscriptUsageUpdate2(usage, meta));
      }
    }
  }
  *projectSystemRecord(record, emit, meta) {
