...
async function runSingleDispatch(config, prompt, opts, attemptSignal, emitter, onTokens) {
  const { AgentHeadless, ContextState } = await import("./agent-headless-TTBEREQV.js");
...
async function runOverridePath(config, ctx, opts, signal, workflowAgentId, onTokens, emitter) {
