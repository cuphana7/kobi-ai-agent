...
${t(
  ...
  if (options.connectIde && config.getIdeMode()) {
    runDeferredTask("ide_connect", async () => {
      ...
      try {
        const { connectIdeForStartup } = await import("./initializer-6WCFNDLL.js");
        await withTimeout(
  ...
  if (config.isInteractive()) {
    runDeferredTask("background_housekeeping", async () => {
      const { startBackgroundHousekeeping } = await import("./scheduler-Z7QLMUWA.js");
