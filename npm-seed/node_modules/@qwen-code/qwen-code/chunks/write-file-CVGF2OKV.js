...
var ARTIFACT_LIKE_EXTENSIONS = /* @__PURE__ */ new Set([
  ".htm",
  ".html",
  ".ipynb",
  ".jpeg",
...
function buildRecordArtifactReminder(config, filePath) {
  ...
  return `If this file is a reusable user-facing artifact, call record_artifact with workspacePath "${workspacePath}" before telling the user it is available in the artifacts panel.`;
}
