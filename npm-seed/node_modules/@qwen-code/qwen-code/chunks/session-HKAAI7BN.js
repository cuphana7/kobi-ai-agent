...
import {
  runNonInteractive
} from "./chunk-L6P4KPHR.js";
import "./chunk-77XJ3SWN.js";
import "./chunk-XUOOWUZS.js";
import {
  StreamJsonOutputAdapter
} from "./chunk-B4G2WOFA.js";
import {
  getAvailableCommands
} from "./chunk-5U27BZ72.js";
import "./chunk-5HOMWMCL.js";
import "./chunk-5DTTYNB7.js";
import "./chunk-D2GFWEXB.js";
import "./chunk-JZETEN3Z.js";
import "./chunk-GWLSNBG4.js";
...
var SystemController = class extends BaseController {
  ...
  async handleGetContextUsage(payload, signal) {
    ...
    try {
      const mod = await import("./contextCommand-OF5SFGH2.js");
      if (signal.aborted) {
        throw new Error("Request aborted");
      }
...
var PermissionController = class extends BaseController {
  ...
  checkPermissionMode() {
    ...
    switch (mode) {
      ...
      case "auto":
      // Auto-approve via LLM classifier — coreToolScheduler enforces the gate
      case "plan":
        return { allowed: true };
      case "default":
  ...
  async handleTeammateApproval(event) {
    try {
      ...
      if (behavior === "allow") {
        ...
        const respondPayload = updatedInput && typeof updatedInput === "object" && !Array.isArray(updatedInput) ? { updatedInput } : void 0;
        await event.respond(
...
`
  ...
  async requestContinueLastTurn() {
    ...
    debugLogger3.info("[Session] requestContinueLastTurn detection", {
      sessionId: this.sessionId,
      kind: detection.kind
    });
  ...
  async processPendingWork() {
    ...
    while ((this.pendingContinueTurn || this.userMessageQueue.length > 0 || this.monitorStartedQueue.length > 0 || this.monitorQueue.length > 0) && !this.isShuttingDown && !this.abortController.signal.aborted) {
  ...
  ensureProcessingStarted() {
    ...
    this.processingPromise = this.processPendingWork().finally(() => {
      ...
      if ((this.pendingContinueTurn || this.userMessageQueue.length > 0 || this.monitorStartedQueue.length > 0 || this.monitorQueue.length > 0) && !this.isShuttingDown && !this.abortController.signal.aborted) {
        this.ensureProcessingStarted();
      }
    });
  }
