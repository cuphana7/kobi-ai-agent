...
import {
  ...
  getSystemInfoFields,
  skillOriginLabel
} from "./chunk-ONVXBTN3.js";
import {
  formatDuration,
  formatTokenCount
} from "./chunk-WK5KFFP6.js";
import {
...
} from "./chunk-OOGQBSTQ.js";
import {
  resolveOpenAILogDir
} from "./chunk-Z6Y6SFX7.js";
import {
  ArenaManager,
...
import {
  external_exports
} from "./chunk-XIOVKC72.js";
import {
  resolveModelId
} from "./chunk-L3KJT4ZZ.js";
import {
  projectUserTranscriptForDisplay
} from "./chunk-JBUMBQAO.js";
import {
  canUseRipgrep
} from "./chunk-U5P7R5TF.js";
import {
  flattenPeerLabel
...
var approvalModeCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context, args) => {
    ...
    const autoModeNotices = mode === "auto" /* AUTO */ && priorMode !== "auto" /* AUTO */ && config ? await import("./useAutoAcceptIndicator-K3M2TEIO.js") : void 0;
    if (config) {
      try {
...
function formatHeldList(held, expiryFor = () => null) {
  ...
  const lines = held.map((entry) => {
    ...
    return `  ${handle}  ${who}
      ...
      held because ${describeHoldCause(entry.cause, entry.policyScope)}` + describeRemaining(entry, expiryFor(entry));
  });
  return [
  ...
  action: /* @__PURE__ */ __name(async (context, args) => {
    ...
    if (verb === void 0 || verb === "list") {
      ...
      return {
        type: "message",
        messageType: "info",
        content: formatHeldList(
          held,
          (entry) => peerMessaging.getHeldExpiryMs(entry.frame.toSessionId)
        )
      };
    }
    ...
    if (outcome === "failed") {
      return {
        type: "message",
        messageType: "error",
        content: "The session could not take the message just now \u2014 its input queue is full, or it could not confirm it still holds the session. It is still waiting; try again in a moment."
      };
    }
    return {
      type: "message",
...
\u26A0\uFE0F ${compressed.warning}` : ""),
            contextCompression: {
              ...
              originalTokenCountIsEstimated: compressed.originalTokenCountIsEstimated ?? false,
              newTokenCountIsEstimated: compressed.newTokenCountIsEstimated ?? false,
  ...
  try {
    ...
    for (const item of context.ui.history ?? []) {
      ...
      for (const tool of item.tools) {
        ...
        if (Number.isFinite(budget) && displayText.length > budget * COMBINED_PASS_TOLERANCE_FACTOR) {
...
async function exportSessionAction(context, args, exportFormat) {
  ...
  try {
    ...
    const workspacePath = context.executionMode === "acp" ? toCanonicalWorkspaceArtifactPath(
      target.filepath,
      config.getTargetDir()
    ) : null;
    const artifacts = workspacePath ? [
      {
        kind: exportFormat.extension === "html" ? "html" : "file",
        storage: "workspace",
        title: path5.basename(target.filepath),
        workspacePath,
...
var expandNowCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context) => {
    ...
    const { expandCollapsedHistory } = await import("./resumeHistoryUtils-7LZ5SWKC.js");
...
var updateCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context) => {
    const [
      ...
      import("./updateCheck-AU6FFINN.js"),
      import("./processUtils-V56V4PBU.js"),
      import("./standalone-update-I3RV7IE7.js"),
      import("./installationInfo-DTMVU7BI.js")
    ]);
