...
import {
  contextCommand
} from "./chunk-4OZY6LN2.js";
import {
  rollbackStandaloneUpdate
} from "./chunk-7JWD2EML.js";
import {
  themeManager
...
import {
  ...
  getGitVersion,
  getNpmVersion
} from "./chunk-BJ2TJY7V.js";
import {
  getReasoningEffortsForConfig
} from "./chunk-AVVSSP4R.js";
import {
...
} from "./chunk-R34ALEH5.js";
import {
  resolveOpenAILogDir
} from "./chunk-JFEWKEKG.js";
import {
  ArenaManager,
...
var approvalModeCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context, args) => {
    ...
    const autoModeNotices = mode === "auto" /* AUTO */ && priorMode !== "auto" /* AUTO */ && config ? await import("./useAutoAcceptIndicator-KXXTKOGD.js") : void 0;
    if (config) {
      try {
...
var expandNowCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context) => {
    ...
    const { expandCollapsedHistory } = await import("./resumeHistoryUtils-5V3KISJ6.js");
...
var updateCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context) => {
    const [
      ...
      import("./updateCheck-FXXOM4YS.js"),
      import("./processUtils-EWKUPVJH.js"),
      import("./standalone-update-XAC364AM.js"),
      import("./installationInfo-HYOWC3BN.js")
    ]);
