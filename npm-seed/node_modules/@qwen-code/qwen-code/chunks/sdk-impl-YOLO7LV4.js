  ...
  if (useOtlp) {
    if (otlpProtocol === "http") {
      ...
      if (tracesUrl || logsUrl || metricsUrl) {
        const { createHttpExporters } = await import("./sdk-exporters-http-7R2ARBPV.js");
      ...
      if (!parsedEndpoint) {
        ...
        const { createGrpcExporters } = await import("./sdk-exporters-grpc-MXTVSE3C.js");
