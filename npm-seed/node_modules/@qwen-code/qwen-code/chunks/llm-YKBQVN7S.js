...
import {
  ...
  parseArguments,
  validateAuthMethod
} from "./chunk-HWKWZSZY.js";
import {
  start_sandbox
} from "./chunk-IH4TNUVS.js";
import "./chunk-YPJZDZMP.js";
import {
...
import "./chunk-BHHR5MEI.js";
import "./chunk-UHBYCY7U.js";
import {
  loadSandboxConfig
...
async function main() {
  ...
  if (argv.listExtensions) {
    ...
    const { handleList: handleListExtensions } = await import("./list-ORJQQUNR.js");
  ...
  const { themeManager, AUTO_THEME_NAME } = await import("./theme-manager-YG3L7BV6.js");
  ...
  if (!process.env["SANDBOX"]) {
    ...
    const onUpdateRelaunch = /* @__PURE__ */ __name(async (relaunchOnFailure) => {
      ...
      const { updateBeforeRelaunch } = await import("./update-relaunch-735DXN5P.js");
...
${finalArgs[promptIndex + 1]}`;
  ...
  if (argv.resume !== void 0) {
    ...
    if (argv.resume === "") {
      const { showResumeSessionPicker } = await import("./StandaloneSessionPicker-KUGOBVEW.js");
  ...
  }
  {
    ...
    const nonInteractiveHousekeeping = !config.isInteractive() || config.getExperimentalZedIntegration() ? await import("./scheduler-NHAWKARI.js") : void 0;
    ...
    if (config.isInteractive()) {
      const { setMaxSizedBoxDebugging } = await import("./MaxSizedBox-I5COUCHZ.js");
    ...
    const { initializeApp } = await import("./initializer-R2EI4UJ6.js");
    ...
    if (config.getExperimentalZedIntegration()) {
      ...
      const { runAcpAgent } = await import("./acpAgent-EHXZXVUB.js");
    ...
    if (config.isInteractive()) {
      ...
      if (selection.renderer === "opentui") {
        try {
          const { startOpenTuiUI } = await import("./start-opentui-ui-3OLDXRMX.js");
      ...
      const { startInteractiveUI } = await import("./startInteractiveUI-UB2HRTV7.js");
...
${input}`;
    ...
    const { validateNonInteractiveAuth } = await import("./validateNonInterActiveAuth-DXCBDHIX.js");
    ...
    if (inputFormat === "stream-json" /* STREAM_JSON */) {
      ...
      const { runNonInteractiveStreamJson } = await import("./session-XODWSTJ3.js");
    ...
    const { runNonInteractive } = await import("./nonInteractiveCli-HRXVUV2H.js");
    nonInteractiveHousekeeping?.startNonInteractiveOpenAILogHousekeeping(
      nonInteractiveConfig,
      settings
    );
