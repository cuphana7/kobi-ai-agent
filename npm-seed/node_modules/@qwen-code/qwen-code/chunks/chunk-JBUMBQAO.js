...
var MANAGED_SESSION_RECORD_SUBTYPES = /* @__PURE__ */ new Set([
  "managed_session_header_v1",
  "managed_session_event_v1",
  "managed_session_commit_v1"
]);
var NON_CONVERSATION_RECORD_SUBTYPES = /* @__PURE__ */ new Set([
...
function isTranscriptConversationRecord(record) {
  return !isTranscriptArtifactRecord(record) && !(record.type === "system" && typeof record.subtype === "string" && NON_CONVERSATION_RECORD_SUBTYPES.has(record.subtype));
}
