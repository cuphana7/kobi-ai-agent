...
var generateIv = /* @__PURE__ */ __name((alg) => crypto.getRandomValues(new Uint8Array(bitLength(alg) >> 3)), "generateIv");
...
var concatSalt = /* @__PURE__ */ __name((alg, p2sInput) => concat(encode(alg), Uint8Array.of(0), p2sInput), "concatSalt");
...
// node_modules/jose/dist/webapi/lib/rsaes.js
var subtleAlgorithm = /* @__PURE__ */ __name((alg) => {
  switch (alg) {
    case "RSA-OAEP":
    case "RSA-OAEP-256":
    case "RSA-OAEP-384":
...
var generateCek = /* @__PURE__ */ __name((alg) => crypto.getRandomValues(new Uint8Array(cekLength(alg) >> 3)), "generateCek");
...
var genericExport = /* @__PURE__ */ __name(async (keyType, keyFormat, key) => {
  if (isKeyObject(key)) {
    if (key.type !== keyType) {
...
var toSPKI = /* @__PURE__ */ __name((key) => genericExport("public", "spki", key), "toSPKI");
var toPKCS8 = /* @__PURE__ */ __name((key) => genericExport("private", "pkcs8", key), "toPKCS8");
