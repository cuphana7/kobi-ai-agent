...
var en_default = {
  ...
  "toolDisplayName.UnderstandVideoSegments": "toolDisplayName.UnderstandVideoSegments",
  ...
  "[fixed-only: runs via media policies, not the model]": "[fixed-only: runs via media policies, not the model]",
  // ============================================================================
  // Help / UI Components
  // ============================================================================
  // Attachment hints
  ...
  "Locked by settings entries you cannot toggle here:": "Locked by settings entries you cannot toggle here:",
  ...
  "This extension will install the following workflows (JavaScript scripts that can start subagents):": "This extension will install the following workflows (JavaScript scripts that can start subagents):",
  "These workflow scripts changed since the installed version: {{names}}.": "These workflow scripts changed since the installed version: {{names}}.",
  ...
  "Reopen this menu to reload hook definitions.": "Reopen this menu to reload hook definitions.",
  "Hook controls and HTTP security settings require a restart.": "Hook controls and HTTP security settings require a restart.",
  "Failed to reload hook definitions: {{error}}": "Failed to reload hook definitions: {{error}}",
  ...
  "Safe mode is on, so no hooks run in this session.": "Safe mode is on, so no hooks run in this session.",
  "Bare mode is on, so no hooks run in this session.": "Bare mode is on, so no hooks run in this session.",
  "All hooks are disabled by the disableAllHooks setting.": "All hooks are disabled by the disableAllHooks setting.",
  "Timeout:": "Timeout:",
  ...
  "Could not compress chat history because the compression summary was empty.": "Could not compress chat history because the compression summary was empty.",
  "Could not compress chat history because the compression summary was truncated.": "Could not compress chat history because the compression summary was truncated.",
  "Could not compress chat history due to an API error.": "Could not compress chat history due to an API error.",
  // ============================================================================
  // Commands - Directory
  // ============================================================================
  ...
  "Large workflow: {{agents}} agents scheduled (warning threshold {{cap}}).": "Large workflow: {{agents}} agents scheduled (warning threshold {{cap}}).",
  "Large workflow: ~{{tokens}} output tokens projected (warning threshold {{cap}}).": "Large workflow: ~{{tokens}} output tokens projected (warning threshold {{cap}}).",
  ...
  "Choose the output style that shapes how responses are written ({{styles}}, or a custom style name).": "Choose the output style that shapes how responses are written ({{styles}}, or a custom style name).",
  "It is saved but does not apply while this workspace is untrusted.": "It is saved but does not apply while this workspace is untrusted.",
  ...
  "Review messages held from other Qwen Code sessions (accept | deny), and manage trusted controllers (controllers | revoke)": "Review messages held from other Qwen Code sessions (accept | deny), and manage trusted controllers (controllers | revoke)"
};
export {
