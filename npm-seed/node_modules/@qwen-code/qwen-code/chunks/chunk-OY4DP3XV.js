...
var WorkspaceRuntimeStopError = class extends Error {
  constructor(code) {
    super(
      code === "workspace_runtime_stop_stale" ? "The workspace changed. Refresh and confirm the affected sessions again." : "The workspace cannot be stopped while other runtime work is pending."
    );
    this.code = code;
    this.name = "WorkspaceRuntimeStopError";
  }
  static {
    __name(this, "WorkspaceRuntimeStopError");
  }
};
