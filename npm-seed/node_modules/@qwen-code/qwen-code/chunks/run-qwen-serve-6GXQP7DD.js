...
import {
  resolveChannelCwd
} from "./chunk-VGLXXHTF.js";
import {
  assertChannelControlWorkspaceCapacity
} from "./chunk-VT3MGD7H.js";
import {
  LOAD_REPLAY_META_KEY
} from "./chunk-FL4QZ67W.js";
import "./chunk-OY4DP3XV.js";
import "./chunk-CKXUWR6I.js";
import "./chunk-TZBFVXNX.js";
import {
  consumeServeFastPathRejectedLoaderKeys,
  loadServeFastPathSettings,
  preResolveServeFastPathHomeEnvOverrides
} from "./chunk-TUYJ6S3L.js";
import "./chunk-W4T4DHDJ.js";
import {
  resolveMaxRegisteredWorkspaces,
  resolveWorkspaceInputs,
  workspaceRegistrationId
} from "./chunk-DACSVV23.js";
import {
...
import {
  sanitizeLogText
} from "./chunk-YWZOEHBT.js";
import "./chunk-6HOTTZKB.js";
import {
...
} from "./chunk-6V4XP46I.js";
import {
  getCliVersion
} from "./chunk-5GYRIOWK.js";
import "./chunk-2RJJSLCF.js";
...
import "./chunk-CHBZHMBA.js";
import "./chunk-4M7RD5QQ.js";
import "./chunk-HEOH7JZY.js";
import "./chunk-XIOVKC72.js";
import "./chunk-ELYIK7SN.js";
...
function resolveChannelWorkspaceGroups(input) {
  ...
  const reject = /* @__PURE__ */ __name((name, code, message) => {
  ...
  for (const name of selection.names) {
    ...
    if (owners.length > 1) {
      ...
      const hinted = preferred === void 0 ? void 0 : owners.find((candidate) => candidate.workspaceCwd === preferred);
      if (!hinted) {
        const rejected = reject(
          name,
          "ambiguous_channel_workspace",
          `Channel "${name}" is configured in multiple registered workspaces (${owners.map((candidate) => candidate.workspaceCwd).join(
            ", "
...
// packages/cli/src/serve/channel-startup-restore.ts
init_esbuild_shims();
function errorMessage(error) {
  return error instanceof Error ? error.message : String(error);
}
__name(errorMessage, "errorMessage");
function isUsableEntry(name) {
  return Boolean(name) && name === name.trim() && sanitizeLogText(name, name.length) === name;
}
__name(isUsableEntry, "isUsableEntry");
function resolveStartupChannelSelection(input) {
  const diagnostics = [];
  const claimsByName = /* @__PURE__ */ new Map();
  const names = [];
  let primaryAllWorkspace;
  ...
  if (primaryAllWorkspace !== void 0) {
    ...
    return {
      selection: { mode: "all" },
      ownerHints: /* @__PURE__ */ new Map(),
      tolerantNames: /* @__PURE__ */ new Set(),
      diagnostics
    };
  }
  const ownerHints = /* @__PURE__ */ new Map();
  const tolerantNames = /* @__PURE__ */ new Set();
  for (const [name, claims] of claimsByName) {
    if (claims.length > 1) {
      diagnostics.push({
        ...
        channel: name,
        message: `Channel "${name}" is listed in the serve.channels of several workspaces (${claims.map((claim) => claim.workspaceCwd).join(", ")}); its owner is resolved from the channel config alone.`
      });
    }
  ...
  return {
    selection: names.length > 0 ? { mode: "names", names } : void 0,
    ownerHints,
    tolerantNames,
    diagnostics
  };
}
__name(resolveStartupChannelSelection, "resolveStartupChannelSelection");
...
async function loadChannelWorkerRuntime() {
  channelWorkerRuntimePromise ??= Promise.all([
    import("./channel-worker-supervisor-GGTS6MM5.js"),
    import("./pidfile-3HRF6UJA.js"),
    import("./runtime-PBC4QVLS.js"),
    import("./cli-entry-path-4VJ3Y6T2.js"),
    import("./channel-worker-group-EJEMLDPE.js"),
    import("./channel-worker-manager-GI3GMPHV.js")
  ]).then(
    ([
      supervisor,
      pidfile,
...
function loadCoreRuntime() {
  coreRuntimePromise ??= import("./core-runtime-5KHWEMVQ.js");
...
function loadLiveDiscoveryRuntime() {
  liveDiscoveryRuntimePromise ??= import("./discovery-BMIULPR4.js");
...
function loadSettingsRuntimeModules() {
  settingsRuntimePromise ??= Promise.all([
    import("./settings-MI63DAKE.js"),
    import("./environment-FXLJ7ENW.js"),
    import("./loadedSettingsAdapter-BCWAHAEI.js"),
    import("./trustedFolders-PGLKXLUG.js")
...
function loadChannelWebhookConfigRuntime() {
  channelWebhookConfigRuntimePromise ??= Promise.all([
    import("./runtime-PBC4QVLS.js"),
    import("./config-utils-3PL3OQOI.js")
...
async function loadServeRuntimeModules() {
  const [
    ...
    import("./server-KQJAQD55.js"),
    import("./bridge-GHWETITW.js"),
    import("./spawnChannel-DMP56IUE.js"),
    import("./process-registry-MDKO6QY2.js"),
    import("./workspace-service-RJOV7URE.js"),
    import("./types-HKLPXZB3.js"),
    import("./daemon-status-provider-PCJP7L7Z.js"),
    import("./workspace-providers-status-AA7TXXGS.js"),
    import("./workspace-skills-status-TYYFTIPU.js"),
    import("./total-session-admission-VXAFAHGR.js"),
    import("./workspace-registry-7M2GJXVY.js"),
    import("./workspace-runtime-coordinator-644IZPWD.js"),
    import("./prompt-terminal-ledger-WOPLWLBQ.js")
  ]);
  return {
...
async function runQwenServeImpl(optsIn, deps, loggerLifecycle) {
  ...
  if (workspaceRegistrationStore === void 0 && process.env["QWEN_SERVE_NO_PERSISTENT_REGISTRATION"] !== "1") {
    const { WorkspaceRegistrationStore } = await import("./workspace-registration-store-OLL5737M.js");
  ...
  let bootChannelOwnerHints = /* @__PURE__ */ new Map();
  let channelOwnerHints = /* @__PURE__ */ new Map();
  let channelStartupTolerantNames = /* @__PURE__ */ new Set();
  ...
  const reportStartupChannelDiagnostic = /* @__PURE__ */ __name((diagnostic) => {
  ...
  }, "reportStartupChannelDiagnostic");
  const startupChannelWorkspaces = workspaceInputs.map((workspace, index) => ({
    workspaceCwd: workspace.cwd,
    primary: index === 0
  }));
  if (!opts.channelSelection && (bootSettings?.serve?.channels !== void 0 || startupChannelWorkspaces.length > 1)) {
    try {
      const restored = resolveStartupChannelSelection({
        ...
        loadStartupChannels: /* @__PURE__ */ __name((workspaceCwd) => (workspaceCwd === boundWorkspace ? bootSettings : (deps.loadWorkspaceBootSettings ?? loadServeFastPathSettings)(
          workspaceCwd
        ))?.serve?.channels, "loadStartupChannels")
      });
      ...
      if (opts.channelSelection) {
        ...
        daemonLog.info("restoring channels from workspace serve.channels", {
          ...
          workspaceCwd: boundWorkspace,
          ...restored.ownerHints.size > 0 ? { requestedByWorkspace: Object.fromEntries(restored.ownerHints) } : {}
        });
      }
    } catch (error) {
  ...
  const { createDaemonToolGuard } = await import("./daemon-git-worktree-guard-LQ3XGSBU.js");
  ...
  const buildRuntime = /* @__PURE__ */ __name(async () => {
    const [runtime, core, settingsRuntime, resolvedCliVersion, trustPolicy] = await Promise.all([
      ...
      cliVersionPromise,
      import("./daemon-trust-policy-KXZY6JQN.js")
    ]);
    ...
    const persistDisabledSkillsFn = /* @__PURE__ */ __name((workspace, skillName, enabled, assertGenerationOpen) => withSettingsLock(workspace, async () => {
      ...
      } = await import("./skill-settings-MNLFQXDX.js");
      const fresh = loadSettingsForPersistence(workspace);
    ...
    const [{ createSubSessionLauncher }, scheduledTaskRoutes] = await Promise.all([
      import("./create-sub-session-FB5YJFI5.js"),
      import("./scheduled-tasks-WEC66H2D.js")
    ]);
    const { sessionAttachmentsRoots } = await import("./session-attachments-root-L75Y47VK.js");
    ...
    void import("./session-pr-refresh-5MHLCSC2.js").then((mod) => {
    ...
    const channelManagementService = /* @__PURE__ */ __name((targetRuntime) => {
      ...
      const pending = (async () => {
        ...
        const [
          ...
          import("./channel-management-service-DISO7Z3P.js"),
          import("./channel-settings-store-7BHSX2TC.js")
        ]);
    ...
    const app2 = runtime.createServeApp(opts, () => actualPort, {
      ...
      updateModelContextWindow: /* @__PURE__ */ __name((workspace, key, size, assertGenerationOpen) => withSettingsLock(workspace, async () => {
        assertGenerationOpen();
        const { updateModelContextWindow } = await import("./model-configuration-LQV2CJZZ.js");
      ...
      installAuthProvider: /* @__PURE__ */ __name((req, assertGenerationOpen) => withSettingsLock(
        ...
        async () => {
          ...
          const { getAuthTypeFromEnv } = await import("./modelConfigUtils-3MJ6OTIS.js");
    ...
    if (workspaceTrustHotReloadAvailable) {
      const [
        ...
        import("./workspace-trust-reconciler-64FF3I3X.js"),
        import("./daemon-trust-policy-monitor-QAZ4KXVK.js")
      ]);
  ...
  const app = runtimeApp ?? createDelegatingServeApp(bootstrapApp, () => runtimeApp, {
    ...
    isPreAuthRequest: webShellMounted ? (req) => import("./web-shell-static-4SY6HOTM.js").then(
  ...
  if (opts.channelSelection) {
    try {
      ...
      channelValidationTrustPolicy = await import("./daemon-trust-policy-KXZY6JQN.js");
          ...
          channelWorkerManager = workerRuntime.createChannelWorkerManager({
            ...
            onCommittedSelection: /* @__PURE__ */ __name((_selection, groups) => {
              ...
              channelOwnerHints = new Map([
                ...
                ...groups.flatMap(
                  (group) => group.selection.mode === "names" ? group.selection.names.map(
                    (name) => [name, group.workspaceCwd]
                  ) : []
                )
              ]);
              channelWebhookConfigVersion += 1;
        ...
        if (resolved) {
          ...
          if (resolved.skipped.length > 0) {
            const hosted = new Set(
              resolved.groups.flatMap(
                (group) => group.selection.mode === "names" ? group.selection.names : []
              )
            );
            const remaining = opts.channelSelection?.mode === "names" ? opts.channelSelection.names.filter((name) => hosted.has(name)) : [];
            opts.channelSelection = remaining.length > 0 ? { mode: "names", names: remaining } : void 0;
            if (!opts.channelSelection) {
              channelWorkspaceGroups = void 0;
              removeCurrentServePidfile();
              reportConfiguredChannelStartupFailure(
