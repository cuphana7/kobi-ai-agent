...
public class UtilCm
{
     ...
     * @author 2019.7.10 / 주재현
     */
    public static void getDownloadResource(UtilCmData utilCmData, int fileId, String version, String downloadPath)
    {
        ...
        if (!isSuccess(ret))
        {
            ...
            //throw new BizException(error.getCode(), error.getDesc(), getErrorMsg(utilCmData, "", ret));
            System.out.println("오류: "+getErrorMsg(utilCmData, "", ret));
        }
    }
